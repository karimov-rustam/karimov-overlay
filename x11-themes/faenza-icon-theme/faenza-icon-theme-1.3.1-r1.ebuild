...
src_prepare() {
	...
	cp "${S}/Faenza/status/scalable/keyboard-brightness-symbolic.svg" \
		"${S}/Faenza/status/scalable/xfpm-brightness-keyboard.svg"

	cp "${S}/Faenza/status/scalable/display-brightness-symbolic.svg" \
		"${S}/Faenza/status/scalable/xfpm-brightness-lcd.svg"
